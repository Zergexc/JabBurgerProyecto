document.getElementById('payment-form').addEventListener('submit', function(event) {
    ...
    // Si todas las validaciones son correctas, proceder con el envío al servidor
    const payment = {
        cardNumber: cardNumber,
        expiryDate: expiryDate,
        cvv: cvv,
        invoiceType: document.querySelector('input[name="invoice"]:checked').value,
        ruc: ruc,
        razonSocial: document.getElementById('razon-social').value,
        address: document.getElementById('address').value,
        total: parseFloat(document.getElementById('total').value) // Asegúrate de que este campo exista y tenga un valor
    };

    console.log('Datos del pago a enviar:', JSON.stringify(payment));
